          ...
          {recentRaw && recentRaw.length > 0 ? (
            ...
            <div className="flex flex-col items-center py-10 text-center">
              <div className="mb-3 flex h-14 w-14 items-center justify-center rounded-full bg-brand-soft">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#1d4ed8" strokeWidth="2" strokeLinecap="round">
                  <path d="M9 9v6M15 9v6"/>
                  <rect x="3.4" y="7.6" width="3.2" height="8.8" rx="1.2"/>
                  <rect x="17.4" y="7.6" width="3.2" height="8.8" rx="1.2"/>
                </svg>
              </div>
              <p className="font-semibold text-foreground">אין אימונים עדיין</p>
              <p className="mt-1 text-sm text-muted-foreground">הנתונים יסונכרנו מ-Garmin ו-Jefit</p>
            </div>
          )}
        </section>
